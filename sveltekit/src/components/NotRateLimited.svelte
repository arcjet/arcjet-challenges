...
<ul>
  <li>
    <a
      ...
      aria-label="Sign up for a free Arcjet account - opens in a new window"
      >Sign up for a free Arcjet account</a
    >
  </li>
  <li>
    ...
    <ul>
      ...
      <li>
        ...
        a <code>window</code> or <code>interval</code> of
  ...
  <li>
    Trigger rate limiting by refreshing this page until you reach your defined
  ...
  <li>
    ...
    <ul>
      <li>
        Screenshot or save a copy of the "Challenge Complete" image from your
        app
      </li>
      <li>Screenshot of your Arcjet dashboard showing the blocked requests</li>
    </ul>
  </li>
  <li>
    ...
    <ul>
      ...
      <li>
        Add something personal - what you enjoyed about the challenge, your
        experience, or thoughts on the product
      </li>
...
<p>
  The personal part of your submission will be evaluated for creativity and
  originality when determining the winners!
</p>
<p>
  Need an idea of what the post should look like? You can see an example post on
  the <a href="https://challenge.arcjet.com/"
    >Arcjet Security Challenge landing page</a
  >.
</p>
